...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $laboratoriancnt = DB::table('users')->where('user_type', '=', 'laboratorian')->count(DB::raw('distinct id'));
        $pharmacistcnt = DB::table('users')->where('user_type', '=', 'pharmacist')->count(DB::raw('distinct id'));
        $receptionistcnt = DB::table('users')->where('user_type', '=', 'receptionist')->count(DB::raw('distinct id'));

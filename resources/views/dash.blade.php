    ...
    <div class="m-0 col-md-12">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    <h3><b><span class="info-box-text">{{__('Laboratorian')}}</span></b></h3>
                    <span class="info-box-number">{{$laboratoriancnt}}</span>
                </div>
                <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        <div class="col-md-3 pr-0 col-sm-6 col-xs-12">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    <h3><b><span class="info-box-text">{{__('Receptionists')}}</span></b></h3>
                    <span class="info-box-number">{{$receptionistcnt}}</span>
                </div>
                <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
